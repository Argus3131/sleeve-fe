...
Component({
  ...
  methods: {
    ...
    //   let accumulation = this.data.result
    //   // 定义计时器
    //   const timer = setInterval(() => {
    //     accumulation++
    //     if (accumulation >= this.properties.max) {
    //       this.data.accumulation = this.properties.max
    //       clearInterval(timer)
    //     } else {
    //       this.data.accumulation = accumulation
    //       this.setData({
    //         result: this.data.accumulation
    //       })
    //     }
    //   }, 500)
    ...
    //   const timer = setInterval(() => {
    //     accumulation--
    //     if (accumulation <= this.properties.min) {
    //       this.data.accumulation = this.properties.min
    //       clearInterval(timer)
    //     } else {
    //       this.data.accumulation = accumulation
    //       this.setData({
